...
class DCISoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class DCIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DCIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DCIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DCIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DCIDateTimeConverter dateTimeConverter = new DCIStandardDateTimeConverter();

    public DCIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DCIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DCIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DCIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DCIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DCIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
