...
public class DCIKPSPublicSoap
{
    ...
    public DCIKPSPublicSoap(){}

    public DCIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DCIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DCIExtendedSoapSerializationEnvelope envelope= new DCIExtendedSoapSerializationEnvelope(DCIExtendedSoapSerializationEnvelope.VER11);
